        ...
        <div className="container py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-gray-400">신상품 소식과 할인 정보를 받아보세요</p>
            </div>
            <div className="flex w-full md:w-auto gap-2">
              <input
                type="email"
                placeholder="이메일 주소를 입력하세요"
                className="flex-1 md:w-80 px-4 py-3 bg-gray-800 rounded-lg border border-gray-700 focus:ring-2 focus:ring-[#e94560] focus:outline-none text-white placeholder-gray-500"
              />
              <button className="btn btn-primary whitespace-nowrap">구독하기</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#e94560] transition-colors"
          ...
          {/* Quick links */}
          <div>
            <h4 className="font-bold mb-4">쇼핑안내</h4>
          ...
          {/* Categories */}
          <div>
            <h4 className="font-bold mb-4">카테고리</h4>
            <ul className="space-y-2 text-gray-400 text-sm">
          ...
          <div>
            ...
            <div className="text-3xl font-bold text-[#e94560] mb-2">1588-0000</div>
            <p className="text-gray-400 text-sm mb-4">
              평일 10:00 - 18:00<br />
              점심시간 12:00 - 13:00<br />
              토/일/공휴일 휴무
            ...
            <div className="space-y-2">
              <Link href="/board/qna" className="block w-full btn btn-outline text-sm">1:1 문의하기</Link>
              <Link href="/board/faq" className="block w-full btn btn-secondary text-sm">자주 묻는 질문</Link>
            </div>
          </div>
        </div>
      </div>
